App.googleAPI = "AIzaSyB85CMctwd2XSVRPBG-IBZEFLSaaMTMmq4"
App.icons = App.Icons.create()
# App.activities = null  #to be initialized in router if null
# App.navbarController = App.NavbarController.create()
...
App.mapInitialize = (map_zoom, wait_time) ->
  ...
  try
    if (document.getElementById("map_canvas"))
      ...
      # App.activityController.set_markers(map)
      @set( 'page_map', map)
    else
